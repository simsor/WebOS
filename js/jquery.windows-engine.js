...
$.fn.newWindow = function(options){
    ...
    var defaults = {
        ...
        statusBar: true,
		minimizeButton: true,
		minimizeIcon: "<img src=\"images/min.png\" />",
		maximizeButton: true,
		maximizeIcon: "<img src=\"images/max.png\" />",
		closeButton: true,
		closeIcon: "<img src=\"images/close.png\" />",
		draggable: true,
		resizeable: true,
		resizeIcon: "#",
		windowType: "standard",
	...
	var idAttr = "";
	if(options.windowId != "")idAttr = 'id="'+options.windowId+'"';
	...
	$windowMinimizeButton.bind('click', function(e){
		$(e.target).parent().parent().parent().slideToggle("slow");
    });
	...
	$windowCloseButton.bind('click', function(e){
	  ...
	  /////////////////////////////////////////////////////////////////////////////////
	  ////////////////        CODE ADDED BY SIMSOR: TASKBAR REMOVE        /////////////
	  /////////////////////////////////////////////////////////////////////////////////
	
	  $("#taskbar").children(".task").each(function(index){
	  	if ($(this).attr("name") == options.windowTitle)
	...
	return this.each(function(index) {
		...
		$this.dblclick(function(event){
			...
			/////////////////////////////////////////////////////////////////////////////////
			////////////////        CODE ADDED BY SIMSOR: TASKBAR INTEGRATION   /////////////
			/////////////////////////////////////////////////////////////////////////////////
			var alreadyOpened = 0;
			  $("#taskbar").children(".task").each(function(index){
	  			if ($(this).attr("name") == options.windowTitle)
	  		...
	  		if (!alreadyOpened)
				$("#taskbar").append("<span class=\"task\" name=\""+options.windowTitle+"\">"+options.windowTitle+"</span>");
				
			$(".task").click(function(){
				var taskName = $(this).attr("name");
				taille = taskName.length;
				
				$(".window-titleBar").each(function(index){
					if ($(this).html().substring(0,taille) == taskName)
